@echo off
REM FlatBuffers Windows x86 (Win32) 构建脚本
REM 需要在 Windows 上安装: CMake, Visual Studio 2019 or later (with C++ development tools)

setlocal EnableDelayedExpansion

set SCRIPT_DIR=%~dp0
set BUILD_DIR=%SCRIPT_DIR%build_win32
set INSTALL_DIR=%SCRIPT_DIR%..\Cpp\flatbuffers_win32
...
REM 运行 CMake 配置 (使用 Visual Studio 生成器, Win32 平台)
